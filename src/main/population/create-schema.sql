...
create index IDX4w2ddk7vl2liqfme8wkfw6jx1 on `application` (`job_id`, `status` asc, `moment` desc);
...
create index IDXl51nhj8ltm6syl39cx1vp1ad9 on `job` (`reference`, `deadline`);
